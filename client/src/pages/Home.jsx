  ...
  return (
    <>
      ...
      <div className="max-w-[1600px] mx-auto px-3 sm:px-5 py-4">
        ...
        {/* Video grid */}
        {!loading && !error && videos.length > 0 && (
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-x-3 gap-y-5 animate-fade-in">
        ...
        {/* Load-more skeletons */}
        {loadingMore && (
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-x-3 gap-y-5 mt-5">
